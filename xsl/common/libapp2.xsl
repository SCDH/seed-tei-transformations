...
<xsl:package
    ...
    <!-- Format sigla from @wit -->
    <xsl:template name="app:sigla" visibility="abstract"/>
    ...
    <xsl:template mode="app:reading-dspt" match="app/note" visibility="abstract"/>
    ...
    <xsl:template mode="app:reading-dspt" match="witDetail" visibility="abstract"/>
    ...
    <xsl:template mode="app:reading-dspt" match="corr" visibility="abstract"/>
    ...
    <xsl:template mode="app:reading-dspt" match="sic[not(parent::choice)]" visibility="abstract"/>
    ...
    <xsl:template mode="app:reading-dspt" match="choice/sic" visibility="abstract"/>

    <xsl:template mode="app:reading-dspt" match="choice[corr and sic]" visibility="abstract"/>
    ...
    <xsl:template mode="app:reading-dspt" match="unclear[not(parent::choice)]" visibility="abstract"/>
    ...
    <xsl:template mode="app:reading-dspt" match="gap" visibility="abstract"/>
